...
namespace HealthyFoods.Persistence.Repositories.Interfaces
{
    public interface IBaseRepository<T> where T : class
    {
        ...
        Task<IEnumerable<T>> GetManyAsync(Expression<Func<T, bool>> predicate, Func<IQueryable<T>, IIncludableQueryable<T, object>> includes, Func<IQueryable<T>, IOrderedQueryable<T>> sort, int pageIndex, int pageSize, bool isTracking = false);
    }
}
